      ...
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Nuestro talentoso equipo de desarrollo está conformado por ocho
            apasionados profesionales de la tecnología, divididos
            equitativamente entre cuatro expertos en el desarrollo back-end y
            cuatro especialistas en el desarrollo front-end. Juntos, fusionamos
            la creatividad y la lógica para crear soluciones digitales
            innovadoras y altamente funcionales. Nuestra colaboración sinérgica
            garantiza que podamos diseñar y construir aplicaciones web y
            sistemas robustos que no solo cautivan visualmente, sino que también
            funcionan de manera eficiente en su núcleo. Estamos comprometidos
            con la excelencia en cada línea de código y en cada detalle de
            diseño, con el objetivo de superar las expectativas de nuestros
          ...
          {people.map((person) => (
            <li key={person.name}>
              <div className="flex items-center gap-x-6">
                <img
                  className="h-40 w-36 rounded-full"
                  src={person.imageUrl}
                  alt=""
                />
                <div>
