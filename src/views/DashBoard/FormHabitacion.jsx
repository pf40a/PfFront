...
const {cambiarEstado, id, setDoc, PutForm, admin} = params

const dispatch = useDispatch()
const habDetalle = dispatch(detailRoom(id))
console.log(habDetalle)
    const [habitacion, setHabitacion] = useState({nombre:"", apellido:"",  admin: admin, email:""})
    const handleChange = (e) => {
        const { name, value} = e.target;
    
        setHabitacion({ ...cliente, [name]: value });
      };
