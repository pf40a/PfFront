            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  {/* Your content */}
                  <img
                    src="https://images.unsplash.com/photo-1535205148555-bcbbc2a78913?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80"
                    alt=""
                  />
                </div>
              </div>
