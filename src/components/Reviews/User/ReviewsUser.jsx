...
const ReviewUser = () => {
  ...
  useEffect(() => {
    ...
    fetchUserData();
    fetchReviews();
    fetchReservationDate(); // Obtener la fecha de salida de la reserva
  }, [reviewId]);
      ...
      {isEditing && (
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-70">
          <div className="bg-white p-4 mx-4 md:mx-auto rounded-lg w-full md:w-96">
            {/* <h2 className="text-2xl font-semibold mb-4">Editar Revisión</h2> */}
            <form>
              <div className="mb-4">
              ...
              <div className="mb-4">
                <textarea
                  value={editReview.comment} // Corregido: Asignar el comentario existente
                  onChange={(e) =>
                    setEditReview({
                      ...editReview,
